...
def modifier(request,pk):
    ...
    histoire1 = Histoire.objects.filter(sous_prefecture=histoire.sous_prefecture)
    ...
    print(noms_sp)
    context={'histoire':histoire,'noms_departements':noms_departements,'noms_sp':noms_sp }
