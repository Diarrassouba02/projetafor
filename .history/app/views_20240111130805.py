...
def rapport_pdf(request, pk):
   ...
   "est en annexe les déclarations ci-après:"]
    ...
    text_lines6=[f"Nom et prénoms du déclarant: {histoire.nom_declarant } {histoire.prenon_declarant}",
                f"Date et lieude naissance: {histoire.date_naissance_declarant } à {histoire.lieu_naissance_declarant}",
    ...
    c.drawString(12,750,"Nota Bene: indiquer après la déclaration en manuscrit la mention suivante:")
