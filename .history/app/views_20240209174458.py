...
def modifier(request,pk):
    ...
    formatted_date = histoire.date_naissance_declarant.strftime('%Y-%m-%d')
    ...
    context={'histoire':histoire,'noms_departements':noms_departements,'noms_sp':noms_sp,'noms_v':noms_v,'formatted_date':formatted_date }
