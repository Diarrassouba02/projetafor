...
def rapport_pdf(request, pk):
    ...
    text_lines1=[]
    text_lines1.append(("1. Direction Régionale:",histoire.nom_region))
    text_lines1.append(("2. Direction Départementale:",histoire.nom_departement))
    text_lines1.append(("3. CGFR de la Sous-Préfecture:",histoire.sous_prefecture))
    text_lines1.append(("4. CVGFR du village:",histoire.nom_village))
    print(text_lines1)
    text1=c.beginText()
