...
def index(request):
    ...
    modqualitedeclreg=Histoire.objects.values('qualite_declarant').distinct()
    print(modqualitedeclreg)
    data = []
    for nomregion in nomregions:
        ...
        data.append({
            ...
            'nbqualitedeclreg':nbqualitedeclreg,
        })
    ...
    nbqualitedeclreg=[entry['nbqualitedeclreg'] for entry in data]
...
def visualisationt(request):
    ...
    nbsous_prefectures = [entry['nbsousprefectures'] for entry in data]
    nbvillages=[entry['nbvillages'] for entry in data]
    context={"labels":labels,'region': region_name,'nbdepartements': nbdepartements,'nbsous_prefectures': nbsous_prefectures,'nbvillages': nbvillages}
