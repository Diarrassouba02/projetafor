...
def visualisationt(request):
    if  request.method == 'POST':
        ...
        region_aggregated = histoires_region.values('nom_region','nom_departement').annotate(
        nbsp=Count('sous_prefecture','nom_departement', distinct=True),nombre_villages=Count('nom_village', distinct=True))
