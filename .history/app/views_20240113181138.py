...
def rapport_pdf(request, pk):
   ...
   "est en annexe les déclarations ci-après:"]
    ...
    if histoire.origine_fondateur:
       if histoire.personne_trouve:
          text_lines9='kolo'
    #text_lines9=text_lines
    #   if histoire.personne_trouve=="Aucune" :
    #      text_lines=f"L'origine du fondateur est: {histoire.origine_fondateur} et il n'a trouvé personne sur les lieux."


    #text_lines9=text_lines
    #text_lines9=f"L'origine du fondateur est:{histoire.origine_fondateur} {histoire.prenom_fondateur}, sont activitée principale: {histoire.activite_fondateur}, lieu d'inhumation: {histoire.lieu_inhimationf}."
