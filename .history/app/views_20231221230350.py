...
def index(request):
    lien_persone_non=Histoire.objects.filter(accord_passe='Non').acount()
    print(lien_persone_non)
    ...
    'labels3': labels3, 'data3': data3,'actp':actp}
    #contex={}
...
def visualisationt(request):
    ...
    return render(request, 'visualisation.html',{'act':act})