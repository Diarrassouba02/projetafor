...
def rapport_pdf(request, pk):
   ...
   "est en annexe les déclarations ci-après:"]
    ...
    c.drawString(4.3*cm,2*cm,"a-t-elle été erigee (Administration du territoire, ARSO, AVB etc.) Pouvez-vous produire ")
    c.drawString(4.3*cm,2.5*cm,"l'acte de création?")
