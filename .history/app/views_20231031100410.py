...
def connection(request):
    if request.method == 'POST':
        ...
        user =authenticate(request, last_name=last_name,first_name=first_name,email=email, password=password)
        if user is not None and user.is_active:
            ...
            messages.info(request, "nom et/ou mot de passe invalides")
