...
def rapport_pdf(request, pk):
   ...
   "est en annexe les déclarations ci-après:"]
    ...
    if histoire.origine_fondateur:
       ...
       if histoire.personne_trouve=="Aucune":
          text_lines9=f"L'origine du fondateur est:{histoire.origine_fondateur} il n'a trouvé personnes sur les lieux."
            ...
            if histoire.lien:
                text_lines9=f"L'origine du fondateur est:{histoire.origine_fondateur}, il à trouvé :{histoire.personne_trouve}.A t'il passé des accords? {histoire.accord_passe},lien avec les personnes trouvées:{histoire.lien}."
            else:
                text_lines9=f"L'origine du fondateur est:{histoire.origine_fondateur}, il à trouvé :{histoire.personne_trouve}.A t'il passé des accords? {histoire.accord_passe},pas lien."
    else:
        text_lines9=""
        if histoire.personne_trouve=="Aucune":
           text_lines9=f"L'origine du fondateur est inconnue il n'a trouvé personnes sur les lieux."
            ...
            if histoire.lien:
                text_lines9=f"L'origine du fondateur est inconnue, il à trouvé: {histoire.personne_trouve}.A t'il passé des accords? {histoire.accord_passe},lien avec les personnes trouvées:{histoire.lien}."
            else:
                text_lines9=f"L'origine du fondateur est inconnue, il à trouvé : {histoire.personne_trouve}.A t'il passé des accords? {histoire.accord_passe},pas lien."
    ...
    paragraphe2.drawOn(c, 1.2 * cm, 3*cm)
    c.showPage()
    c.save()
    buf.seek(0)
