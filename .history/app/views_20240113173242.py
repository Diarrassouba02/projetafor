...
def rapport_pdf(request, pk):
   ...
   "est en annexe les déclarations ci-après:"]
    ...
    #text_lines9=f"L'origine du fondateur est: 
    #{histoire.origine_fondateur} {histoire.prenom_fondateur}, sont activitée principale:
    #{histoire.activite_fondateur}, lieu d'inhumation: {histoire.lieu_inhimationf}."
