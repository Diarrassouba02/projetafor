...
#   Etude anciens sites région
    ...
    for element in regli:
        ...
        dicregli[element['nom_region']] = dicregli.get(element['nom_region'], 0) + len(element['nom_region'])
    ...
    for item in reglitige:
        ...
        dicreglitige[item['nom_region']]=dicreglitige.get(item['nom_region'],0)+len(item['zone_litigee'])
