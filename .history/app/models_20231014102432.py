...
class Histoire(models.Model):
    ...
    nom_region=models.CharField(max_length=2000,choices=CHOIXreg)
    nom_departement=models.CharField(max_length=200)
    sous_prefecturere=models.CharField(max_length=200)
    non_villageg=models.CharField(max_length=200)
