...
def rapport_pdf(request, pk):
   ...
   "est en annexe les déclarations ci-après:"]
    ...
    text_lines8=f"Le village à été fondé par {histoire.nom_fondateur} {histoire.prenom_fondateur} sont activitée principale était {histoire.activite_fondateur}. lieu d'inhumation: {histoire.lieu_inhimationf}."
