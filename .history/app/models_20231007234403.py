...
class Histoire(models.Model):
    ...
    CHOIXreg=(("District autonome d'Abidjan","District autonome d'Abidjan"),
           ("Région de l'Agnéby-Tiassa","Région de l'Agnéby-Tiassa"),("Region du Bélier","Région du Bélier"))
    nomreg=models.CharField(max_length=2000,choices=CHOIXreg)
    departementreg=models.CharField(max_length=200)
    sous_prefecturereg=models.CharField(max_length=200)
    non_du_villageg=models.CharField(max_length=200)
    ...
    nomdec=models.CharField(max_length=200)
    prenondec=models.CharField(max_length=200)
    date_naissancedec=models.DateField()
    lieu_naissancedec=models.CharField(max_length=200)
    qualitédec=models.CharField(max_length=200)
    signification=models.TextField()
    nomf=models.CharField(max_length=200)
    prenomf=models.CharField(max_length=200)
    activitef=models.CharField(blank=True,max_length=200)
    dat_intallationf=models.CharField(max_length=200)
    lieu_hinimationf=models.BooleanField()
    originef=models.CharField(max_length=200)
    personne_trouvef=models.CharField(max_length=200,choices=CHOIX,default="aucun")
    accord_passef=models.TextField(default="pas d'accords passé")
    lien=models.TextField()
    date_intallation=models.CharField(max_length=200)
