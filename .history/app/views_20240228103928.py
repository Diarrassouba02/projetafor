...
#   Etude anciens sites région
    ...
    #labels_an_site = [item['nom_region'] for item in  count_by_region]
    #data_an_site = [item['count_by_region'] for item in  count_by_region]
    ...
    'lien':lien,'liennul':liennul,'count_by_region':count_by_region}
