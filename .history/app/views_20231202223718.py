...
def rapport_pdf(request, pk):
    ...
    # Insérer une image en haut au milieu de la page
    image_path = "/home/afor/Bureau/BASE/static/images/repuplique.jpg"  # Remplacez ceci par le chemin de votre image
    c.drawInlineImage(image_path, A4[0]/2 - inch, A4[1] - inch, width=1.5*inch, height=1.5*inch)
