...
def rapport_pdf(request, pk):
   ...
   "est en annexe les déclarations ci-après:"]
    ...
    for i in histoire.nomlignage:
        if i['nom_lignage']:
            if i['ordre']:
               text_lines12=f"Ordre {i['ordre']}, nom: {i['nom_lignage']}"+text_lines12
            else:
                text_lines12=f"Ordre Inconnu, nom:{i['nom_lignage']}"+text_lines12
        else:
            text_lines12=f"Ordre {i['ordre']}, nom: Inconnu"+text_lines12
