...
def rapport_pdf(request, pk):
   ...
   "est en annexe les déclarations ci-après:"]
    ...
    text_lines7=f"Le nom du village est <b> {histoire.nom_village} </b><BR/>\ , qui signifie {histoire.signification} rrrrrrrrrrrrrrrrrrrrrrrrddddddee eeee eee eeee ee eeeeeeeeeeeeeeeeeneeeeeeeeeeeeeeeeeeeeee"
    ...
    paragraphe.drawOn(c, 1.2 * cm, 1.9*cm)
    c.showPage()
