...
#   Etude anciens sites région.
    #an=ast.literal_eval(histoire.ancien_site)
    #print(an)
    ...
    for element in regan:
        ...
        count_by_region[element['nom_region']] = count_by_region.get(element['nom_region'], 0) + len(ancien_sites)
    print(count_by_region)
    #regan.ancien_site=ast.literal_eval(regan.ancien_site)
    #print(regan)
