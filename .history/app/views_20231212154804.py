...
def rapport_pdf(request, pk):
   ...
   "je me suis rendu au village ci-dessus mentionné et ai recueilli en présence des personnes dont la liste",
   "est en annexe les déclarations ci-après"]
    ...
    text6 = c.beginText()
    text6.setFillColorRGB(0.1,0.1,0.1)
    text6.setTextOrigin(4.3*cm/2 ,495)
