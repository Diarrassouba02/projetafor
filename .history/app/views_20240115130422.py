...
def rapport_pdf(request, pk):
   ...
   "est en annexe les déclarations ci-après:"]
    ...
    c.rect(1.1 * cm, 1.1 * cm, 80, 18, fill=True)
    c.setFillColor(colors.black)
    c.drawString(4.3*cm,1.5*cm,"Quels sont les modes d'accès a Ia terre ? Y a-t-il un chef de terre ? Comment se")
    c.drawString(4.3*cm,2*cm,"la mise à disposition des terres ' (heritage, don, prêt, achat, location)")
