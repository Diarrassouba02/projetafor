...
def rapport_pdf(request, pk):
   ...
   "est en annexe les déclarations ci-après:"]
    ...
    text_lines7=f"Le nom du village est {histoire.nom_village}, qui signifie {histoire.signification} rrrrrrrrrrrrrrrrrrrrrrrrddddddee eeee eee ee ee ee eeeeeeeeeeeeeeeeeneeeeeeeeeeeeeeeeeeeeee"
    ...
    paragraphe.wrapOn(c, 520,40)
    paragraphe.drawOn(c, 1.2 * cm, 300)
    c.showPage()
