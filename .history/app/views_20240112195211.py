...
def rapport_pdf(request, pk):
   ...
   "est en annexe les déclarations ci-après:"]
    ...
    text_lines7=f"Le nom du village est {histoire.nom_village}, qui signifie rrrrrrrrrrrrrrrrrrrrrrrrddddddeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"
    ...
    # Définir la largeur disponible pour le texte
    width_available: Union[float, int] = 400

    c.drawText(text, x_start, y_start, maxWidth=width_available)
    #style = getSampleStyleSheet()['Normal']
    #paragraphe = Paragraph(text_lines7, style)
    #paragraphe.wrapOn(c, 500,40)  # Spécifiez la largeur et la hauteur maximales pour le Preformatted
    #paragraphe.drawOn(c, 1.2 * cm, 50)
    c.showPage()
