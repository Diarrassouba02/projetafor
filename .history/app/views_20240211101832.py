...
def index(request):
    ...
    quad=Histoire.objects.values('qualite_declarant').annotate(
        nb=Count('qualite_declarant', distinct=True)).order_by('-nb')[:2]
    #for item in quad:
    #    if item['qualite_declarant'] == 'Chef De Village' or item['qualite_declarant'] == 'Chef Du Village':
    #       item['qualite_declarant'] = 'Chef du village'
    #print(quad)
    ...
    'quad':quad,'labelsquad':labelsquad,'dataquad':labelsquad,'labelsepoque':labelsepoque,'dataepoque':
    dataepoque}
