...
def rapport_pdf(request, pk):
   ...
   "est en annexe les déclarations ci-après:"]
    ...
    text_lines7=[f"Le nom du village est {histoire.nom_region}, qui signifie rrrrrrrrrrrrrrrrrrrrrrrrddddddeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"]
    ...
    preformate = Preformatted(text_lines7,style=style)
    preformate.wrapOn(c, 400, 200)  # Spécifiez la largeur et la hauteur maximales pour le Preformatted
    preformate.drawOn(c, 1.2 * cm, 200)

    #text_object.textLines(text_lines7, width=14)
