document.addEventListener("DOMContentLoaded", function() {
            ...
            function createSuccessorInputs() {
                ...
                nameInput.setAttribute('placeholder', 'Parlez');
                nameInput.type = "text";
                ...
                firstNameLabel.textContent = "Prénom du successeur speech-input";
                ...
                accessionDateLabel.textContent = "Date d'accession speech-input";
                ...
                accessionDateInput.className = "speech-input";
