...
function createCampementInputs() {
    ...
    campementDiv.classList.add("form-group", "col-md-6");  // Ajout de classes Bootstrap

    const nomLabel = document.createElement("label");
    nomLabel.setAttribute("for", `nom_${campementCount}`);
    nomLabel.textContent = "Nom du campement";

    const nomInput = document.createElement("input");
    nomInput.type = "text";
    nomInput.name = `nom_${campementCount}`;
    nomInput.setAttribute("id", `nom_${campementCount}`);
    nomInput.classList.add("form-control");  // Ajout de la classe Bootstrap pour les inputs

    const removeButton = document.createElement("button");
    removeButton.type = "button";
    removeButton.textContent = "-";
    removeButton.classList.add("btn", "btn-danger", "mt-2");  // Utilisation du bouton Bootstrap de style danger
...
// Assurez-vous que vous avez ces variables définies ailleurs dans votre script :
// let campementCount = 0;
// const campementsContainer = document.getElementById("YOUR_CONTAINER_ID");
// const campementCountInput = document.getElementById("YOUR_COUNT_INPUT_ID");
// const addCampementButton = document.getElementById("YOUR_BUTTON_ID");
