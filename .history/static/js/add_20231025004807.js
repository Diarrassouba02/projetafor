...
document.addEventListener("DOMContentLoaded", function() {
            ...
            function createSuccessorInputs() {
                ...
                successorDiv.className = "row successor";

                const nameLabelCol = document.createElement("div");
                nameLabelCol.className = "col-md-4";

                const firstNameLabelCol = document.createElement("div");
                firstNameLabelCol.className = "col-md-4";

                const accessionDateLabelCol = document.createElement("div");
                accessionDateLabelCol.className = "col-md-4";
                ...
                nameInput.className = "successor-input speech-input form-control";
                ...
                firstNameInput.className = "successor-input  speech-input";
                ...
                nameLabelCol.appendChild(nameInput);
                firstNameLabelCol.appendChild(firstNameLabel);
                firstNameLabelCol.appendChild(firstNameInput);
                accessionDateLabelCol.appendChild(accessionDateLabel);
                accessionDateLabelCol.appendChild(accessionDateInput);

                successorDiv.appendChild(nameLabelCol);
                successorDiv.appendChild(firstNameLabelCol);
                successorDiv.appendChild(accessionDateLabelCol);
...
document.addEventListener("DOMContentLoaded", function() {
            ...
            function createLignageInputs() {
                ...
                lignageDiv.className = "form-row lignage";

                const ordreLabelCol = document.createElement("div");
                ordreLabelCol.className = "col-md-4";

                const nomLabelCol = document.createElement("div");
                nomLabelCol.className = "col-md-4";
                ...
                ordreInput.className = "lignage-input form-control";
                ...
                nomInput.className = "lignage-input speech-input  form-control mb-3";
                ...
                ordreLabelCol.appendChild(ordreLabel);
                ordreLabelCol.appendChild(ordreInput);
                nomLabelCol.appendChild(nomLabel);
                nomLabelCol.appendChild(nomInput);

                lignageDiv.appendChild(ordreLabelCol);
                lignageDiv.appendChild(nomLabelCol);
