...
document.addEventListener("DOMContentLoaded", function() {
            ...
            function createNeighboringVillageInputs() {
                ...
                neighboringVillageNameInput.placeholder = "Village Voisin";
                neighboringVillageNameInput.className = "form-control";
                neighboringVillageNameDiv.appendChild(neighboringVillageNameInput);

                const neighboringVillageLimitDiv = document.createElement("div");
                neighboringVillageLimitDiv.className = "col-md-5";
                const neighboringVillageLimitInput = document.createElement("input");
                neighboringVillageLimitInput.type = "text";
                neighboringVillageLimitInput.id = `neighboringVillageLimit_${neighboringVillageCount}`;
                neighboringVillageLimitInput.placeholder = "Limite";
                neighboringVillageLimitInput.className = "form-control";
                neighboringVillageLimitDiv.appendChild(neighboringVillageLimitInput);

                const removeNeighboringVillageButtonDiv = document.createElement("div");
                removeNeighboringVillageButtonDiv.className = "col-md-1";
                ...
                neighboringVillageDiv.appendChild(neighboringVillageLimitDiv);
            ...
            // Appeler la fonction pour afficher par défaut les champs pour citer les villages voisins et limites
